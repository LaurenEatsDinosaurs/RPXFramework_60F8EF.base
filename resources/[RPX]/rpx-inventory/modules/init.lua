...
-- https://overextended.github.io/docs/rpx-inventory/Getting%20Started/config

shared = {
	resource = GetCurrentResourceName(),
	framework = GetConvar('inventory:framework', 'rpx'),
...
if IsDuplicityVersion() then
	...
	client = {
		...
		imagepath = GetConvar('inventory:imagepath', 'nui://rpx-inventory/web/images'),
...
if not lib then
	return spamError('rpx-inventory requires the ox_lib resource, refer to the documentation.')
end

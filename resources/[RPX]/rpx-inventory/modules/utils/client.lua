...
-- Replace rpx-inventory notify with ox_lib (backwards compatibility)
...
RegisterNetEvent('rpx-inventory:notify', Utils.Notify)
...
RegisterNetEvent('rpx-inventory:itemNotify', Utils.ItemNotify)

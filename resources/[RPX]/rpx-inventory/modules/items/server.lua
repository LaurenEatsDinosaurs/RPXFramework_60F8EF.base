...
TriggerEvent('rpx-inventory:itemList', ItemList)
...
CreateThread(function()
	...
	if clearStashes ~= '' then
		pcall(MySQL.query.await, ('DELETE FROM rpx-inventory WHERE lastupdated < (NOW() - INTERVAL %s) OR data = "[]"'):format(clearStashes))
	end

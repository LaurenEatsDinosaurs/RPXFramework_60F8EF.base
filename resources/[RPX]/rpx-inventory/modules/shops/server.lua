...
lib.callback.register('rpx-inventory:openShop', function(source, data)
...
local function canAffordItem(inv, currency, price)
	local moneyInPossession = Inventory.GetItem(inv, currency, false, true) or 0
	local canAfford = price >= 0 and moneyInPossession >= price
...
lib.callback.register('rpx-inventory:buyItem', function(source, data)
